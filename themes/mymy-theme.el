...
(defcustom mymy-scale-org-document-title t
...
(defcustom mymy-scale-outline-headlines t
...
(defcustom mymy-scale-org-agenda-structure t
...
(defcustom mymy-scale-volatile-highlight t
...
;;;###autoload
(defun mymy-scale-font (control default-height)
...
(let ((class '((class color) (min-colors 89)))
      ...
      (ol1 `(,@(mymy-scale-font mymy-scale-outline-headlines 1.0) :weight bold :foreground "black" :background "white"))
      (ol2 '(:height 1.0 :weight bold :foreground "black" :background "white"))
      (ol3 '(:height 1.0 :weight bold :foreground "black" :background "white"))
      (ol4 '(:height 1.0 :weight bold :foreground "black"))
      (ol5 '(:height 1.0 :weight bold :foreground "black"))
      (ol6 '(:height 1.0 :weight bold :foreground "black"))
      (ol7 '(:height 1.0 :weight bold :foreground "black"))
      (ol8 '(:height 1.0 :weight bold :foreground "black"))
      ...
      (volatile-highlight-supersize `(,@(mymy-scale-font mymy-scale-volatile-highlight 1.0) :underline nil :foreground "white" :background "#9E3699")) ; flash-region
  ...
  (custom-theme-set-faces
   ...
   `(cfw:face-title ((,class (:height 1.0 :foreground "#676767" :weight bold :inherit variable-pitch))))
   ...
   `(custom-button ((,class (:box (:line-width 1 :style released-button) :foreground "black" :background "lightgrey"))))
   ...
   `(custom-face-tag ((,class (:family "Sans Serif" :height 1.0 :weight bold))))
   `(custom-group-tag ((,class (:height 1.0 :weight bold :foreground "blue1"))))
   `(custom-group-tag-1 ((,class (:family "Sans Serif" :height 1.0 :weight bold :foreground "red1"))))
   ...
   `(custom-variable-tag ((,class (:family "Sans Serif" :height 1.0 :weight bold :foreground "blue1"))))
   ...
   `(font-latex-sectioning-1-face ((,class (:family "Sans Serif" :height 1.0 :weight bold :foreground "cornflower blue"))))
   ...
   `(google-translate-listen-button-face ((,class (:height 1.0))))
   ...
   `(mymy-org-deadline-overdue ((,class (:foreground "#F22659"))))
   `(mymy-org-deadline-today ((,class (:weight bold :foreground "#4F4A3D" :background "#FFFFCC"))))
   `(mymy-org-deadline-tomorrow ((,class (:foreground "#40A80B"))))
   `(mymy-org-deadline-future ((,class (:foreground "#40A80B"))))
   `(mymy-gnus-unseen ((,class (:weight bold :foreground "#FC7202"))))
   `(mymy-gnus-date ((,class (:foreground "#FF80BF"))))
   `(mymy-gnus-size ((,class (:foreground "#8FBF60"))))
   `(mymy-todo-items-face ((,class (:weight bold :foreground "#FF3125" :background "#FFFF88"))))
   ...
   `(magit-diff-file-header ((,class (:height 1.0 :weight bold :foreground "#4183C4"))))
   ...
   `(magit-section-title ((,class (:family "Sans Serif" :height 1.0 :weight bold :foreground "cornflower blue" :inherit nil))))
   ...
   `(org-agenda-block-count ((,class (:foreground "#A5A5A5"))))
   `(org-agenda-calendar-event ((,class ( :foreground "#3774CC"))))
   `(org-agenda-calendar-sexp ((,class (:foreground "#327ACD"))))
   `(org-agenda-clocking ((,class (:foreground "black"))))
   `(org-agenda-column-dateline ((,class ,column)))
   `(org-agenda-current-time ((,class (:underline t :foreground "#1662AF"))))
   `(org-agenda-date ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.0) :weight bold :foreground "#1662AF"))))
   `(org-agenda-date-today ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.0) :weight bold :foreground "black" :background "#F5FABE"))))
   `(org-agenda-date-weekend ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.0) :weight bold :foreground "#1662AF"))))
   `(org-agenda-diary ((,class (:weight bold :foreground "green4"))))
   ...
   `(org-agenda-structure ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.0) :weight bold :foreground "#1F8DD6"))))
   `(org-archived ((,class (:foreground "gray70"))))
   `(org-beamer-tag ((,class (:foreground "#2C2C2C" :background "#FFF8D0"))))
   ...
   `(org-checkbox ((,class (:weight bold :foreground "#123555" :background "#D4D4D4"))))
   ...
   `(org-document-title ((,class (,@(mymy-scale-font mymy-scale-org-document-title 1.0)  :weight bold :foreground "black"))))
   ...
   `(org-inlinetask ((,class (:foreground "#777777" :background "#FFFFD6"))))
   ...
   `(org-mode-line-clock ((,class (:foreground "black" :background "#FFA335"))))
   `(org-mode-line-clock-overrun ((,class (:weight bold :foreground "white" :background "#FF4040"))))
   ...
   `(org-todo ((,class (:weight bold :foreground "red" :background "white"))))
...
(custom-theme-set-variables 'mymy
