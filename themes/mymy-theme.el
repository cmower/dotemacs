...
(let ((class '((class color) (min-colors 89)))
      ...
      (volatile-highlight-supersize `(,@(mymy-scale-font mymy-scale-volatile-highlight 1.1) :underline nil :foreground "white" :background "#9E3699")) ; flash-region
  ...
  (custom-theme-set-faces
   ...
   `(org-agenda-date-weekend ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.0) :weight bold :foreground "black"))))
