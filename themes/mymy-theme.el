...
(let ((class '((class color) (min-colors 89)))
      ...
      (ol1 `(,@(mymy-scale-font mymy-scale-outline-headlines 1.3) :weight bold :overline "#A7A7A7" :foreground "#3C3C3C" :background "#F0F0F0"))
  ...
  (custom-theme-set-faces
   ...
   `(org-agenda-date ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.6) :weight bold :foreground "#1662AF"))))
   `(org-agenda-date-today ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.6) :weight bold :foreground "#4F4A3D" :background "#FFFFCC"))))
   `(org-agenda-date-weekend ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.6) :weight bold :foreground "#4E4E4E"))))
   ...
   `(org-agenda-structure ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.6) :weight bold :foreground "#1F8DD6"))))
   ...
   `(org-document-title ((,class (,@(mymy-scale-font mymy-scale-org-document-title 1.8)  :weight bold :foreground "black"))))
