...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-agenda-date-today ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.0) :weight bold :foreground "#4F4A3D" :background "#FFFFCC"))))
   `(org-agenda-date-weekend ((,class (,@(mymy-scale-font mymy-scale-org-agenda-structure 1.0) :weight bold :foreground "#4E4E4E"))))
   ...
   `(org-done ((,class (:weight bold :foreground "#BBBBBB" :background "#F0F0F0"))))
