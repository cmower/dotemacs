...
(defcustom monokai-height-minus-1 1.0 ;; 0.8
  "Font size -1."
  :type 'number
  :group 'monokai)

(defcustom monokai-height-plus-1 1.0 ;; 1.1
  "Font size +1."
  :type 'number
  :group 'monokai)

(defcustom monokai-height-plus-2 1.0 ;; 1.15
  "Font size +2."
  :type 'number
  :group 'monokai)

(defcustom monokai-height-plus-3 1.0 ;; 1.2
  "Font size +3."
  :type 'number
  :group 'monokai)

(defcustom monokai-height-plus-4 1.0 ;; 1.3
  "Font size +4."
  :type 'number
  :group 'monokai)
...
(defcustom monokai-comments "#b8b298" ;; "#75715E"
